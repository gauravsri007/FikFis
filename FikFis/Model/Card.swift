...
extension Card{
    static func all() -> [Card] {
        return [
            ...
            Card(id: 7, title: "Womens shoes", imageUrl: "paging1"),
            ...
            Card(id: 9, title: "Kid clothes", imageUrl: "paging1"),
            Card(id: 10, title: "Min. 40% off | Washing machines", imageUrl: "paging1"),
            Card(id: 11, title: "Mens clothes", imageUrl: "product1"),
            Card(id: 12, title: "Kid shoes", imageUrl: "product1"),
            Card(id: 13, title: "Womens shoes", imageUrl: "paging1"),
            ...
            Card(id: 15, title: "Kid clothes", imageUrl: "paging1"),
            Card(id: 16, title: "Min. 40% off | Washing machines", imageUrl: "paging1"),
