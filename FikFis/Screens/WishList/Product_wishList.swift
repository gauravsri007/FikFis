...
struct Product_wishList: View {
    ...
    var lowerView : some View{
        ...
        VStack(alignment: .leading){
            HStack{
                RoundedButton(showingAlert: false, alertTitle: "", alertMessage: "", btnTitle: "ADD TO CART ", btnHeight: 30, btnWidth: 110, font: .custom_font(.medium,size: 13))
                HStack{
                    Button{
...
#Preview {
    Product_wishList(product: ProductM(id: 0, productRating: 3, productName: "POCO M6 5G (Orion Blue, 8GB RAM, 256GB Storage)", productPrice: "£399", imageUrl: "product", ProductDiscount: "47% Off"),productCount: 1)
}
